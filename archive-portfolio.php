            ...
            <div class="container-fluid">
                <div class="row">
                  <ul class="grid effect-2 slow " id="grid">
                    ...
                    <li class="post-box <?php echo $tax ?> " ><a href="#" data-toggle="modal" data-img="<?php echo $image_url ?>" data-w="<?php echo $image_w ?>" data-h="<?php echo $image_h ?>" data-target="#lightbox"><?php the_post_thumbnail() ?></a></li>
                    <?php endwhile; ?>                 
