...
$of_options[] = array( 	"name" 		=> "Página Inicial",
						"type" 		=> "heading"
				);
					
$of_options[] = array( 	"name" 		=> "Olá!",
						"desc" 		=> "",
						"id" 		=> "introduction",
						"std" 		=> "<h3 style=\"margin: 0 0 10px;\">Bem vindo a tela de opções do Tema</h3>
						Aqui você poderá personalizar alguns item do template.",
						"icon" 		=> true,
						"type" 		=> "info"
				);
...
$of_options[] = array(
					    ...
					    "desc"  => "Coloque aqui o Titulo de destaque da Página Inicial do Site",
					    "id"    => "title_destaque",
					    "std"   => "Default Text",
					    "type"  => "textarea"
				);
...
$of_options[] = array(
					    "name"  => "Texto Destaque",
					    "desc"  => "Coloque aqui um pequeno texto de destaque da Página Inicial do Site",
					    "id"    => "text_destaque",
					    "std"   => "Default Text",
					    "type"  => "textarea"
				);
...
$of_options[] = array( 	"name" 		=> "Facebook",
						"desc" 		=> "Coloque aqui a url completa de seu perfil",
						"id" 		=> "link_fb",
						"std" 		=> "Default Value",
						"type" 		=> "text"
				);
